...
Build **Nested Checkboxes** as described: Build a nested checkboxes component with parent-child selection logic
...
Walk through the primary user journey for **Nested Checkboxes** step by step in your README notes as you implement.
...
**Core interaction:** User performs the main action described in the problem (Build a nested checkboxes component with parent-child selection logic).
...
```bash
npm run test:exercise -- ui-coding/nested-checkboxes
```