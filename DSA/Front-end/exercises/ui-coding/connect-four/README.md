...
Build **Connect Four** as described: Build a game for two players who take turns to drop colored discs from the top into a vertically suspended board/grid
...
Walk through the primary user journey for **Connect Four** step by step in your README notes as you implement.
...
**Core interaction:** User performs the main action described in the problem (Build a game for two players who take turns to drop colored discs from the top into a vertically suspended board/grid).
...
```bash
npm run test:exercise -- ui-coding/connect-four
```