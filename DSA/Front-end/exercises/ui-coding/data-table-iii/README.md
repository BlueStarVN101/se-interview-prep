...
Build **Data Table III** as described: Build a generalized data table with pagination and sorting features
...
Walk through the primary user journey for **Data Table III** step by step in your README notes as you implement.
...
**Core interaction:** User performs the main action described in the problem (Build a generalized data table with pagination and sorting features).
...
```bash
npm run test:exercise -- ui-coding/data-table-iii
```