...
Build **Star Rating** as described: Build a star rating component that shows a row of star icons for users to select the number of filled stars corresponding to the rating
...
Walk through the primary user journey for **Star Rating** step by step in your README notes as you implement.
...
**Core interaction:** User performs the main action described in the problem (Build a star rating component that shows a row of star icons for users to select the number of filled stars corresponding to the rating).
...
```bash
npm run test:exercise -- ui-coding/star-rating
```