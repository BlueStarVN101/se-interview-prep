...
Build **Holy Grail** as described: Build the famous holy grail layout consisting of a header, 3 columns, and a footer
...
Walk through the primary user journey for **Holy Grail** step by step in your README notes as you implement.
...
**Core interaction:** User performs the main action described in the problem (Build the famous holy grail layout consisting of a header, 3 columns, and a footer).
...
```bash
npm run test:exercise -- ui-coding/holy-grail
```