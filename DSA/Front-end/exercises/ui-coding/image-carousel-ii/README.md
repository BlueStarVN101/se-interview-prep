...
Build **Image Carousel II** as described: Build an image carousel that smoothly transitions between images
...
```bash
npm run test:exercise -- ui-coding/image-carousel-ii
```