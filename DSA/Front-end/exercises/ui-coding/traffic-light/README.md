...
Build **Traffic Light** as described: Build a traffic light where the lights switch from green to yellow to red after predetermined intervals and loop indefinitely
...
```bash
npm run test:exercise -- ui-coding/traffic-light
```