...
import ModalDialogIi from './index.js';

describe('Modal Dialog II', () => {
  describe('initial render', () => {
    it('should render dialog when open', () => {
      render(createElement(ModalDialogIi, { isOpen: true, onClose: () => {}, title: 'Confirm', children: 'Delete?' }));
  ...
  describe('edge cases', () => {
    it('should handle edge case: Nested dialogs', () => {
      ...
      expect(() => render(createElement(ModalDialogIi, { isOpen: true, onClose: () => {}, title: "Confirm", children: "Delete item?" }))).not.toThrow();
    });
