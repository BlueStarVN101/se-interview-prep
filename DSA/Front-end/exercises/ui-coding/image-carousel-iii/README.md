...
Build **Image Carousel III** as described: Build an image carousel that smoothly transitions between images and has a minimal DOM footprint
...
```bash
npm run test:exercise -- ui-coding/image-carousel-iii
```