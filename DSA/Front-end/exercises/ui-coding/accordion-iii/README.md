...
Build **Accordion III** as described: Build a fully accessible accordion component that has keyboard support according to ARIA specifications
...
```bash
npm run test:exercise -- ui-coding/accordion-iii
```