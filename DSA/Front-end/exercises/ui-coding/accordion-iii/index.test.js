...
import AccordionIii from './index.js';
...
describe('Accordion III', () => {
  describe('initial render', () => {
    it('should collapse all sections initially unless specified', () => {
      render(createElement(AccordionIii, { sections: SECTIONS_FIXTURE }));
  ...
  describe('edge cases', () => {
    it('should handle edge case: All collapsed initially', () => {
      ...
      expect(() => render(createElement(AccordionIii, { sections: SECTIONS_FIXTURE }))).not.toThrow();
    });
