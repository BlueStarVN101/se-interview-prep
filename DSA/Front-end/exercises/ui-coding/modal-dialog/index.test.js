...
describe('Modal Dialog', () => {
  describe('initial render', () => {
    it('should render dialog when open', () => {
      render(createElement(ModalDialog, { isOpen: true, onClose: () => {}, title: 'Confirm', children: 'Delete?' }));
  ...
  describe('edge cases', () => {
    it('should handle edge case: Nested dialogs', () => {
      ...
      expect(() => render(createElement(ModalDialog, { isOpen: true, onClose: () => {}, title: "Confirm", children: "Delete item?" }))).not.toThrow();
    });
