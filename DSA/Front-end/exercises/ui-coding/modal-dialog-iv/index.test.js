...
import ModalDialogIv from './index.js';

describe('Modal Dialog IV', () => {
  describe('initial render', () => {
    it('should render dialog when open', () => {
      render(createElement(ModalDialogIv, { isOpen: true, onClose: () => {}, title: 'Confirm', children: 'Delete?' }));
  ...
  describe('edge cases', () => {
    it('should handle edge case: Nested dialogs', () => {
      ...
      expect(() => render(createElement(ModalDialogIv, { isOpen: true, onClose: () => {}, title: "Confirm", children: "Delete item?" }))).not.toThrow();
    });
