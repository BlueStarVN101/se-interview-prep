...
Build **Modal Dialog IV** as described: Build a fully-accessible modal dialog component that supports all required keyboard interactions
...
```bash
npm run test:exercise -- ui-coding/modal-dialog-iv
```