...
Build **Tabs** as described: Build a tabs component that displays a list of tab elements and one associated panel of content at a time
...
Three tabs → clicking "Settings" shows settings panel only.
...
```bash
npm run test:exercise -- ui-coding/tabs
```