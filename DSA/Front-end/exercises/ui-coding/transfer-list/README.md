...
Build **Transfer List** as described: Build a component that allows transferring items between two lists
...
Walk through the primary user journey for **Transfer List** step by step in your README notes as you implement.
...
**Core interaction:** User performs the main action described in the problem (Build a component that allows transferring items between two lists).
...
```bash
npm run test:exercise -- ui-coding/transfer-list
```