...
Build **File Explorer** as described: Build a file explorer component to navigate files and directories in a tree-like hierarchical viewer
...
Walk through the primary user journey for **File Explorer** step by step in your README notes as you implement.
...
**Core interaction:** User performs the main action described in the problem (Build a file explorer component to navigate files and directories in a tree-like hierarchical viewer).
...
```bash
npm run test:exercise -- ui-coding/file-explorer
```