...
Build **Tabs III** as described: Build a fully accessible tabs component that has keyboard support according to ARIA specifications
...
Arrow keys, Home/End per WAI-ARIA Tabs Pattern.
...
```bash
npm run test:exercise -- ui-coding/tabs-iii
```