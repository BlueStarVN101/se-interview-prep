...
Build **Progress Bars** as described: Build a list of progress bars that fill up gradually when they are added to the page
...
Walk through the primary user journey for **Progress Bars** step by step in your README notes as you implement.
...
**Core interaction:** User performs the main action described in the problem (Build a list of progress bars that fill up gradually when they are added to the page).
...
```bash
npm run test:exercise -- ui-coding/progress-bars
```