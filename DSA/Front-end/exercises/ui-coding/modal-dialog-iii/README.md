...
Build **Modal Dialog III** as described: Build a moderately-accessible modal dialog component that supports common ways to close the dialog
...
```bash
npm run test:exercise -- ui-coding/modal-dialog-iii
```