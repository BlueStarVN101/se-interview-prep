...
Build **Tic-tac-toe II** as described: Build an N x N tic-tac-toe game that requires M consecutive marks to win
...
Walk through the primary user journey for **Tic-tac-toe II** step by step in your README notes as you implement.
...
**Core interaction:** User performs the main action described in the problem (Build an N x N tic-tac-toe game that requires M consecutive marks to win).
...
```bash
npm run test:exercise -- ui-coding/tic-tac-toe-ii
```