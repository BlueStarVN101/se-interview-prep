...
Build **Data Table II** as described: Build a users data table with sorting features
...
Walk through the primary user journey for **Data Table II** step by step in your README notes as you implement.
...
**Core interaction:** User performs the main action described in the problem (Build a users data table with sorting features).
...
```bash
npm run test:exercise -- ui-coding/data-table-ii
```