...
Implement **Palindromic Substrings** as described: Implement a function to count all palindromic substrings in a string
...
```bash
npm run test:exercise -- algo-coding/palindromic-substrings
```