...
Implement **Count Set Bits in a Binary Number** as described: Implement a function to find set bits in binary representation of a given integer
...
```bash
npm run test:exercise -- algo-coding/count-set-bits-in-a-binary-number
```