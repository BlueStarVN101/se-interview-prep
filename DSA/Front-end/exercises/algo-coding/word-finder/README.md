...
Implement **Word Finder** as described: Implement a data structure where words can be added and support wildcard searching
...
```bash
npm run test:exercise -- algo-coding/word-finder
```