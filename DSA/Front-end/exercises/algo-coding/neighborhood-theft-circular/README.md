...
Implement **Neighborhood Theft (Circular)** as described: Implement a function to find maximum money to rob in circular houses without alerting police
...
```bash
npm run test:exercise -- algo-coding/neighborhood-theft-circular
```