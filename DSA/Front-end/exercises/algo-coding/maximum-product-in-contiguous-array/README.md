...
Implement **Maximum Product in Contiguous Array** as described: Implement a function to find the subarray which has the largest product
...
```bash
npm run test:exercise -- algo-coding/maximum-product-in-contiguous-array
```