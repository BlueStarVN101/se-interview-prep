...
Implement **Pair sum** as described: Implement a function to find two numbers within an array of integers that add up to a target integer
...
```bash
npm run test:exercise -- algo-coding/pair-sum
```