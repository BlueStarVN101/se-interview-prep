...
Implement **Task Coordination** as described: Implement a function to find minimum intervals for tasks with cooldown
...
```bash
npm run test:exercise -- algo-coding/task-coordination
```