...
Implement **Segment Words** as described: Implement a function to check whether a string be formed from dictionary words
...
```bash
npm run test:exercise -- algo-coding/segment-words
```