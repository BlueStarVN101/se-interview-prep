...
Implement **Find Missing Number in Sequence** as described: Implement a function to find the missing element in a sorted array
...
```bash
npm run test:exercise -- algo-coding/find-missing-number-in-sequence
```