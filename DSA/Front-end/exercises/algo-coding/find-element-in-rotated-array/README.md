...
Implement **Find Element in Rotated Array** as described: Implement a function to find an integer in a rotated sorted array
...
```bash
npm run test:exercise -- algo-coding/find-element-in-rotated-array
```