...
Implement **Validate Binary Search Tree** as described: Implement a function to validate whether a binary tree is a valid binary search tree
...
```bash
npm run test:exercise -- algo-coding/validate-binary-search-tree
```