...
Implement **Linked List Detect Cycle** as described: Implement a function to detect if there are cycles in a linked list
...
```bash
npm run test:exercise -- algo-coding/linked-list-detect-cycle
```