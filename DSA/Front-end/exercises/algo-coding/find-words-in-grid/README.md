...
Implement **Find Words in Grid** as described: Implement a function to find all the words present in the grid
...
```bash
npm run test:exercise -- algo-coding/find-words-in-grid
```