...
Implement **Find the Longest Palindromic Substring** as described: Implement a function to find the longest palindromic substring
...
```bash
npm run test:exercise -- algo-coding/find-the-longest-palindromic-substring
```