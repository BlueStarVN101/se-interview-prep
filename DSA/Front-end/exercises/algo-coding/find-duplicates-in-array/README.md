...
Implement **Find Duplicates in Array** as described: Implement a function to check if there are any duplicate numbers in the array
...
```bash
npm run test:exercise -- algo-coding/find-duplicates-in-array
```