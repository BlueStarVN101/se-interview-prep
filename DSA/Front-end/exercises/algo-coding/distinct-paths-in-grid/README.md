...
Implement **Distinct Paths in Grid** as described: Implement a function to calculate distinct paths for a robot moving on an m x n grid
...
```bash
npm run test:exercise -- algo-coding/distinct-paths-in-grid
```