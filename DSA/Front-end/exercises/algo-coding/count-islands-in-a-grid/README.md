...
Implement **Count Islands in a Grid** as described: Implement a function to count distinct islands in a 2D binary grid
...
```bash
npm run test:exercise -- algo-coding/count-islands-in-a-grid
```