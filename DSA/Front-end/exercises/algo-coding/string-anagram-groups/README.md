...
Implement **String Anagram Groups** as described: Implement a function to group an array of strings into anagrams
...
```bash
npm run test:exercise -- algo-coding/string-anagram-groups
```