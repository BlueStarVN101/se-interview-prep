...
Implement **Binary Search Tree Kth Smallest Element** as described: Implement a function to find the kth smallest node in a BST
...
```bash
npm run test:exercise -- algo-coding/binary-search-tree-kth-smallest-element
```