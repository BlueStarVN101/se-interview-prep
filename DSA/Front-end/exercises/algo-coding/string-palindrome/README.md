...
Implement **String Palindrome** as described: Implement a function to determine if a string is a palindrome
...
```bash
npm run test:exercise -- algo-coding/string-palindrome
```