...
Implement **Linked List** as described: Implement a linked list data structure containing the common linked list methods
...
```bash
npm run test:exercise -- algo-coding/linked-list
```