...
Implement **Merge New Interval** as described: Implement a function to insert a new interval in the given intervals
...
```bash
npm run test:exercise -- algo-coding/merge-new-interval
```