...
Implement **Longest Non-repeating Substring** as described: Implement a function to find the length of longest substring with unique characters
...
```bash
npm run test:exercise -- algo-coding/longest-non-repeating-substring
```