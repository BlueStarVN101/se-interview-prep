...
Implement **Graph Count Connected Components** as described: Implement a function to count connected components in a graph
...
```bash
npm run test:exercise -- algo-coding/graph-count-connected-components
```