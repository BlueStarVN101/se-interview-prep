...
Implement **End of Array Reachable** as described: Implement a function to determine if the end of the array is reachable
...
```bash
npm run test:exercise -- algo-coding/end-of-array-reachable
```