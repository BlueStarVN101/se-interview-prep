...
Implement **Longest Increasing Subsequence** as described: Implement a function to find the length of the longest increasing subsequence
...
```bash
npm run test:exercise -- algo-coding/longest-increasing-subsequence
```