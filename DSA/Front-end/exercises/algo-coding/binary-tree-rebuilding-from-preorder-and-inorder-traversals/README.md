...
Implement **Binary Tree Rebuilding from Preorder and Inorder Traversals** as described: Implement a function to construct a binary tree from preorder and inorder traversals
...
```bash
npm run test:exercise -- algo-coding/binary-tree-rebuilding-from-preorder-and-inorder-traversals
```