...
Implement **Binary Tree Maximum Total Path** as described: Implement a function to find the maximum total of nodes in a binary tree path
...
```bash
npm run test:exercise -- algo-coding/binary-tree-maximum-total-path
```