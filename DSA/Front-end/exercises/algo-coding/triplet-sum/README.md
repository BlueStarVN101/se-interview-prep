...
Implement **Triplet Sum** as described: Implement a function to find all unique triplets with distinct indices that sum to 0
...
```bash
npm run test:exercise -- algo-coding/triplet-sum
```