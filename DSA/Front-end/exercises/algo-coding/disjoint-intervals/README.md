...
Implement **Disjoint Intervals** as described: Implement a function to determine the minimum amount of removals to get non-overlapping intervals
...
- Sort by start or end time first; merge with overlap rules.
...
- Line sweep is a common follow-up for room/meeting problems.
...
```bash
npm run test:exercise -- algo-coding/disjoint-intervals
```