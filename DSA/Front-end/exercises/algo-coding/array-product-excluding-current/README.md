...
Implement **Array Product Excluding Current** as described: Implement a function to find the product of elements in an array excluding the current element
...
```bash
npm run test:exercise -- algo-coding/array-product-excluding-current
```