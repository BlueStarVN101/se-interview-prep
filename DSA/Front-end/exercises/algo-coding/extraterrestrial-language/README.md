...
Implement **Extraterrestrial Language** as described: Implement a function to verify and return an extraterrestrial language's alphabet order
...
```bash
npm run test:exercise -- algo-coding/extraterrestrial-language
```