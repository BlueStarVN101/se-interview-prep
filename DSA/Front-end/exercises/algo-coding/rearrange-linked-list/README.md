...
Implement **Rearrange Linked List** as described: Implement a function to rearrange the nodes in a linked list
...
```bash
npm run test:exercise -- algo-coding/rearrange-linked-list
```