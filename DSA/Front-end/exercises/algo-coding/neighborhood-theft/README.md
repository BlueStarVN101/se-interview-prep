...
Implement **Neighborhood Theft** as described: Implement a function to find maximum money to rob without alerting police
...
```bash
npm run test:exercise -- algo-coding/neighborhood-theft
```