...
Implement **Trie (Prefix Tree)** as described: Implement a trie-prefix-tree with insert, search, and starts with functionality
...
```bash
npm run test:exercise -- algo-coding/trie-prefix-tree
```