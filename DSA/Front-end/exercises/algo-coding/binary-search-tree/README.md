...
Implement **Binary Search Tree** as described: Implement a binary search tree data structure including essential BST operations
...
```bash
npm run test:exercise -- algo-coding/binary-search-tree
```