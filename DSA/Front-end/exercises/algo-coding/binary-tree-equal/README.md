...
Implement **Binary Tree Equal** as described: Implement a function to determine whether two binary trees are equal
...
```bash
npm run test:exercise -- algo-coding/binary-tree-equal
```