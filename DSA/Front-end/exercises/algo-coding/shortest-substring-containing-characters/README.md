...
Implement **Shortest Substring Containing Characters** as described: Implement a function to return the smallest substring of a string containing all characters from another string
...
```bash
npm run test:exercise -- algo-coding/shortest-substring-containing-characters
```