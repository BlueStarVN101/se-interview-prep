...
Implement **Binary Tree Serialization and Deserialization** as described: Implement a function to serialize and deserialize a binary tree
...
```bash
npm run test:exercise -- algo-coding/binary-tree-serialization-and-deserialization
```