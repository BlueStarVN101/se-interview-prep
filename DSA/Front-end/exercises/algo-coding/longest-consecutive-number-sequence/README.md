...
Implement **Longest Consecutive Number Sequence** as described: Implement a function to find the length of the longest consecutive number sequence
...
```bash
npm run test:exercise -- algo-coding/longest-consecutive-number-sequence
```