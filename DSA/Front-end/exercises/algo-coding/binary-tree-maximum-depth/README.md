...
Implement **Binary Tree Maximum Depth** as described: Implement a function to find the maximum depth of a binary tree
...
```bash
npm run test:exercise -- algo-coding/binary-tree-maximum-depth
```