...
Implement **Staircase Climbing Combinations** as described: Implement a function to find the number of ways to reach at the top of staircase
...
```bash
npm run test:exercise -- algo-coding/staircase-climbing-combinations
```