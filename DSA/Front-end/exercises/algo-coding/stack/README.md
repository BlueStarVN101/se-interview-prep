...
Implement **Stack** as described: Implement a stack data structure containing the common stack methods

## 2. Requirements

### Functional requirements

- Implement push, pop, peek/top, isEmpty with O(1) amortized operations.
...
```bash
npm run test:exercise -- algo-coding/stack
```