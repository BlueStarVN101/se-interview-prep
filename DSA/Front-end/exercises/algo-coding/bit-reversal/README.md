...
Implement **Bit Reversal** as described: Implement a function to flip the order of the bits in a given number
...
```bash
npm run test:exercise -- algo-coding/bit-reversal
```