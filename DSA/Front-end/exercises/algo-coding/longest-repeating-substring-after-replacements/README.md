...
Implement **Longest Repeating Substring After Replacements** as described: Implement a function to find the longest uniform substring after up to k replacements
...
```bash
npm run test:exercise -- algo-coding/longest-repeating-substring-after-replacements
```