...
Implement **Meeting Calendar** as described: Implement a function to check if all meetings can be attended
...
```bash
npm run test:exercise -- algo-coding/meeting-calendar
```