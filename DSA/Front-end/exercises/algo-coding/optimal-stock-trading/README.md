...
Implement **Optimal Stock Trading** as described: Implement a function to find the maximum profit achievable by buying and selling a stock once
...
```bash
npm run test:exercise -- algo-coding/optimal-stock-trading
```