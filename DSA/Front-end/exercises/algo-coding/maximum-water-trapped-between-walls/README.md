...
Implement **Maximum Water Trapped Between Walls** as described: Implement a function to find the maximum water volume between two walls in an array of walls
...
```bash
npm run test:exercise -- algo-coding/maximum-water-trapped-between-walls
```