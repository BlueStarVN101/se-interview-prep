...
Implement **Minimum Meeting Rooms Needed** as described: Implement a function to find the minimum number of required conference rooms
...
```bash
npm run test:exercise -- algo-coding/minimum-meeting-rooms-needed
```