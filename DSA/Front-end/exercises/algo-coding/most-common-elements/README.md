...
Implement **Most Common Elements** as described: Implement a function to determine the most common elements in an integer array
...
```bash
npm run test:exercise -- algo-coding/most-common-elements
```