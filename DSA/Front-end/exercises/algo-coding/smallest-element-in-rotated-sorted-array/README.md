...
Implement **Smallest element in rotated sorted array** as described: Implement a function to find the smallest element in rotated sorted array
...
```bash
npm run test:exercise -- algo-coding/smallest-element-in-rotated-sorted-array
```