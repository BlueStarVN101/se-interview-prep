...
Implement **Merge Overlapping Intervals** as described: Implement a function to merge overlapping intervals
...
```bash
npm run test:exercise -- algo-coding/merge-overlapping-intervals
```