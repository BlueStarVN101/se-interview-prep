...
Implement **Promise.reject** as described: Implement a function to return a Promise object rejected with a reason
...
```bash
npm run test:exercise -- js-functions/promise-reject
```