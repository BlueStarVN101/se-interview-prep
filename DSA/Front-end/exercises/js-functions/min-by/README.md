...
Implement **Min By** as described: Implement a function that finds the minimum element based on the specified criteria
...
```bash
npm run test:exercise -- js-functions/min-by
```