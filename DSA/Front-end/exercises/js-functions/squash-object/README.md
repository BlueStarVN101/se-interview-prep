...
Implement **Squash Object** as described: Implement a function that returns a new object after squashing the input object into a single level of depth
...
```bash
npm run test:exercise -- js-functions/squash-object
```