...
Implement **JSON.stringify II** as described: Implement a function that converts a JavaScript value into a JSON string
...
```bash
npm run test:exercise -- js-functions/json-stringify-ii
```