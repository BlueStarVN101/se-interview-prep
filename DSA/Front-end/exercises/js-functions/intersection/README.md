...
Implement **Intersection** as described: Implement a function that returns the unique values present in every array

## 2. Requirements

### Functional requirements

- Implement a function that returns the unique values present in every array
...
```bash
npm run test:exercise -- js-functions/intersection
```