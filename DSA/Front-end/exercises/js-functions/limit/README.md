...
Implement **Limit** as described: Implement a function that accepts a callback and restricts its invocation to at most N times
...
```bash
npm run test:exercise -- js-functions/limit
```