...
Implement **Difference** as described: Implement a function that returns the values from one array that are not present in another

## 2. Requirements

### Functional requirements

- Implement a function that returns the values from one array that are not present in another
...
```bash
npm run test:exercise -- js-functions/difference
```