...
Implement **Classnames II** as described: Implement a function that conditionally joins CSS class names together and also handles de-duplication and function values
...
```bash
npm run test:exercise -- js-functions/classnames-ii
```