...
Implement **getElementsByClassName** as described: Implement a function to get all DOM elements that contain the specified classes
...
```bash
npm run test:exercise -- js-functions/getelementsbyclassname
```