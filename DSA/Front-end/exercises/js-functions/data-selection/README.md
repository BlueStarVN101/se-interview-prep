...
Implement **Data Selection** as described: Implement a function to filter rows of data matching a specified requirement
...
```bash
npm run test:exercise -- js-functions/data-selection
```