...
Implement **Find Index** as described: Implement a function that returns the index of the first element in the array that satisfies the provided testing function
...
```bash
npm run test:exercise -- js-functions/find-index
```