...
Implement **useCounter** as described: Implement a hook that manages a counter state, with some additional convenience utility methods
...
```bash
npm run test:exercise -- js-functions/usecounter
```