...
Implement **Range Right** as described: Implement a function that returns a sequence of numbers in descending order
...
```bash
npm run test:exercise -- js-functions/range-right
```