...
Implement **useBoolean** as described: Implement a hook that manages a boolean state, with additional convenience utility methods
...
```bash
npm run test:exercise -- js-functions/useboolean
```