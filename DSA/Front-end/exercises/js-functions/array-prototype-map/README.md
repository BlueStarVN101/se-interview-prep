...
Implement **Array.prototype.map** as described: Implement the Array.prototype.map () method

## 2. Requirements

### Functional requirements

- Polyfill or replicate `Array.prototype.map` behavior per ECMAScript where tests apply.
...
```bash
npm run test:exercise -- js-functions/array-prototype-map
```