...
Implement **Array.prototype.concat** as described: Implement the Array.prototype.concat () method

## 2. Requirements

### Functional requirements

- Polyfill or replicate `Array.prototype.concat` behavior per ECMAScript where tests apply.
...
```bash
npm run test:exercise -- js-functions/array-prototype-concat
```