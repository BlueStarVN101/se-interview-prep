...
Implement **Union By** as described: Implement a function that creates an array of unique values, in order, from all given arrays.
...
```bash
npm run test:exercise -- js-functions/union-by
```