...
Implement **Function Length** as described: Implement a function that returns the number of parameters expected by a function
...
```bash
npm run test:exercise -- js-functions/function-length
```