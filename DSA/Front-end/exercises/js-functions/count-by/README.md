...
Implement **Count By** as described: Implement a function that counts how many array elements map to each key

## 2. Requirements

### Functional requirements

- Implement a function that counts how many array elements map to each key
...
```bash
npm run test:exercise -- js-functions/count-by
```