...
Implement **Size** as described: Implement a function that returns the size of a collection

## 2. Requirements

### Functional requirements

- Implement a function that returns the size of a collection
...
```bash
npm run test:exercise -- js-functions/size
```