...
Implement **Get** as described: Implement a function to safely access a nested value in an object

## 2. Requirements

### Functional requirements

- Implement a function to safely access a nested value in an object
...
```bash
npm run test:exercise -- js-functions/get
```