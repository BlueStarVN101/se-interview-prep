...
Implement **Function.prototype.bind** as described: Implement the Function.prototype.bind () function that creates a new function with the `this` keyword set to a provided value

## 2. Requirements

### Functional requirements

- Polyfill or replicate `Array.prototype.bind` behavior per ECMAScript where tests apply.
...
```bash
npm run test:exercise -- js-functions/function-prototype-bind
```