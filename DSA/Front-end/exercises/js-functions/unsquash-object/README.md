...
Implement **Unsquash Object** as described: Implement a function that reconstructs a nested object from dot-delimited keys.
...
```bash
npm run test:exercise -- js-functions/unsquash-object
```