...
Implement **Promise.withResolvers** as described: Implement a function that returns an object containing a new `Promise` object and two functions to resolve or reject it
...
```bash
npm run test:exercise -- js-functions/promise-withresolvers
```