...
Implement **Cancellable Interval** as described: Implement a function that acts like setInterval but returns a function to cancel the interval
...
```bash
npm run test:exercise -- js-functions/cancellable-interval
```