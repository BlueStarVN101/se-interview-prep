...
Implement **Make Counter II** as described: Implement a function that returns a counter object with methods to retrieve and manipulate the value
...
```bash
npm run test:exercise -- js-functions/make-counter-ii
```