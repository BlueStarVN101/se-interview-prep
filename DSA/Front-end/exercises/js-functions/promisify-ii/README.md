...
Implement **Promisify II** as described: Implement a promisify function that allows the original function to override the return value
...
```bash
npm run test:exercise -- js-functions/promisify-ii
```