...
Implement **useClickAnywhere** as described: Implement a hook that handles click events anywhere in the window

## 2. Requirements

### Functional requirements

- Implement a hook that handles click events anywhere in the window
...
```bash
npm run test:exercise -- js-functions/useclickanywhere
```