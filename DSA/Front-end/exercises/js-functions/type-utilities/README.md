...
Implement **Type Utilities** as described: Implement utilities to determine primitive variable types in JavaScript
...
```bash
npm run test:exercise -- js-functions/type-utilities
```