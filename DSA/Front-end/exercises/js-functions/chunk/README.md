...
Implement **Chunk** as described: Implement a function that creates an array of elements split into smaller groups of a specified size
...
```bash
npm run test:exercise -- js-functions/chunk
```