...
Implement **Map Async** as described: Implement a function that maps an array of items with an asynchronous mapping function
...
```bash
npm run test:exercise -- js-functions/map-async
```