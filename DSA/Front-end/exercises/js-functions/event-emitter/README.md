...
Implement **Event Emitter** as described: Implement a class that can subscribe to and emit events that trigger attached callback functions
...
```bash
npm run test:exercise -- js-functions/event-emitter
```