...
Implement **Sleep** as described: Implement a function that pauses for a specified duration before resuming execution
...
```bash
npm run test:exercise -- js-functions/sleep
```