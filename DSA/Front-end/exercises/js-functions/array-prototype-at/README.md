...
Implement **Array.prototype.at** as described: Implement the Array.prototype.at () method

## 2. Requirements

### Functional requirements

- Polyfill or replicate `Array.prototype.at` behavior per ECMAScript where tests apply.
...
```bash
npm run test:exercise -- js-functions/array-prototype-at
```