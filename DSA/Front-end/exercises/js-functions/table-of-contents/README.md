...
Implement **Table of Contents** as described: Implement a function to construct a table of contents from an HTML document
...
```bash
npm run test:exercise -- js-functions/table-of-contents
```