...
Implement **Number of Arguments** as described: Implement a function that returns the number of arguments it was called with
...
```bash
npm run test:exercise -- js-functions/number-of-arguments
```