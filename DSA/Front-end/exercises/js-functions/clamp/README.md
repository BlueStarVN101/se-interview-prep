...
Implement **Clamp** as described: Implement a function that restricts a number to an inclusive range

## 2. Requirements

### Functional requirements

- Implement a function that restricts a number to an inclusive range
...
```bash
npm run test:exercise -- js-functions/clamp
```