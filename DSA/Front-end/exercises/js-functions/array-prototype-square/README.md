...
Implement **Array.prototype.square** as described: Implement a custom Array.prototype.square () method that squares the values in an array

## 2. Requirements

### Functional requirements

- Polyfill or replicate `Array.prototype.square` behavior per ECMAScript where tests apply.
...
```bash
npm run test:exercise -- js-functions/array-prototype-square
```