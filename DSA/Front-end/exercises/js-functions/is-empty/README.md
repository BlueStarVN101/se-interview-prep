...
Implement **Is Empty** as described: Implement a function to check whether a value should be treated as empty

## 2. Requirements

### Functional requirements

- Implement a function to check whether a value should be treated as empty
...
```bash
npm run test:exercise -- js-functions/is-empty
```