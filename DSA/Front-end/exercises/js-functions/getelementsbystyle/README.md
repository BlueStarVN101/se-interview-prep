...
Implement **getElementsByStyle** as described: Implement a function to get all DOM elements that are rendered using the specified style
...
```bash
npm run test:exercise -- js-functions/getelementsbystyle
```