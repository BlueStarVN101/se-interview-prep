...
Implement **Intersection With** as described: Implement a function that computes the intersection of arrays using a comparator function

## 2. Requirements

### Functional requirements

- Implement a function that computes the intersection of arrays using a comparator function
...
```bash
npm run test:exercise -- js-functions/intersection-with
```