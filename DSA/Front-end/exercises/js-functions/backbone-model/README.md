...
Implement **Backbone Model** as described: Implement a class resembling Backbone.Model which allows storing of attributes/values and responding to changes in specific attribute values
...
```bash
npm run test:exercise -- js-functions/backbone-model
```