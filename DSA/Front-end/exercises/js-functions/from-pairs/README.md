...
Implement **From Pairs** as described: Implement a function that returns an object composed from key-value pairs
...
```bash
npm run test:exercise -- js-functions/from-pairs
```