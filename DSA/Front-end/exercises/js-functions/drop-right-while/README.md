...
Implement **Drop Right While** as described: Implement a function that excludes elements from the end of an array until the predicate returns false
...
```bash
npm run test:exercise -- js-functions/drop-right-while
```