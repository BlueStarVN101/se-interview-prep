...
Implement **Drop While** as described: Implement a function that excludes elements from the beginning of an array until the predicate returns false
...
```bash
npm run test:exercise -- js-functions/drop-while
```