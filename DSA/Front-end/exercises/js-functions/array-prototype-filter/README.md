...
Implement **Array.prototype.filter** as described: Implement the Array.prototype.filter () method

## 2. Requirements

### Functional requirements

- Polyfill or replicate `Array.prototype.filter` behavior per ECMAScript where tests apply.
...
```bash
npm run test:exercise -- js-functions/array-prototype-filter
```