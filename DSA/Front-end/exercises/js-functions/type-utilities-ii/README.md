...
Implement **Type Utilities II** as described: Implement utilities to determine non-primitive variable types in JavaScript
...
```bash
npm run test:exercise -- js-functions/type-utilities-ii
```