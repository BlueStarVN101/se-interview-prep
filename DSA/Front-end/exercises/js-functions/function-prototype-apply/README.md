...
Implement **Function.prototype.apply** as described: Implement the Function.prototype.apply () function that calls the function with a given `this` value and arguments as an array

## 2. Requirements

### Functional requirements

- Polyfill or replicate `Array.prototype.apply` behavior per ECMAScript where tests apply.
...
```bash
npm run test:exercise -- js-functions/function-prototype-apply
```