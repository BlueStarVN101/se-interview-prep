...
Implement **Group By** as described: Implement a function that groups array values based on a function

## 2. Requirements

### Functional requirements

- Implement a function that groups array values based on a function
...
```bash
npm run test:exercise -- js-functions/group-by
```