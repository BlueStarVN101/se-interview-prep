...
Implement **Array.prototype.reduce** as described: Implement the Array.prototype.reduce () method

## 2. Requirements

### Functional requirements

- Polyfill or replicate `Array.prototype.reduce` behavior per ECMAScript where tests apply.
...
```bash
npm run test:exercise -- js-functions/array-prototype-reduce
```