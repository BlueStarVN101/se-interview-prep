...
Implement **Once** as described: Implement a function that accepts a callback and restricts its invocation to at most once
...
```bash
npm run test:exercise -- js-functions/once
```